...
const { cssModuleLoader, postcssLoader } = require('./commonLoader')
const { chooseDefaultEntryFile, createTemplate, getLibAbsPath } = require('./utils')
...
module.exports = (defaultConfig, commandConfig = {}) => {
  ...
  if (isExist) {
    ...
    const htmlFilePath = createTemplate(require(sereinConfigPath))
    handleHtmlWebpackPlugin(webpackChainOption, htmlFilePath)
    ...
    const htmlFilePath = createTemplate({})
    handleHtmlWebpackPlugin(webpackChainOption, htmlFilePath)
  ...
  exportOptions.entry = chooseDefaultEntryFile(commandConfig.entry)
  return exportOptions
}

function handleHtmlWebpackPlugin(webpackChainOption, htmlFilePath) {
  webpackChainOption.plugin('HtmlWebpackPlugin').use(
    HtmlWebpackPlugin,
    [{
      filename: 'index.html',
